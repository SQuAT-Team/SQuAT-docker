...
/**
 * Sets up the specific {@link SillyBot} and scenarios used in this specific case study.
 */
public class LoadHelper {
	...
	public List<SillyBot> loadBotsForArchitecturalAlternatives(List<ArchitecturalVersion> architecturalAlternatives, ArchitecturalVersion initialArchitecture){
		...
		try {
			ModifiabilitySillyBot m1Bot=new ModifiabilitySillyBot(/*115f*/calculateModifiabilityComplexity(m1Scenario,KAMPPCMBot.TYPE_COMPLEXITY,initialArchitecture),"m1",responseTimeScenario1);
			ModifiabilitySillyBot m2Bot=new ModifiabilitySillyBot(/*190.5f*/calculateModifiabilityComplexity(m2Scenario,KAMPPCMBot.TYPE_COMPLEXITY,initialArchitecture),"m2",responseTimeScenario2);
			PerformanceSillyBot p1Bot=new PerformanceSillyBot(/*111.7639f*/calculatePerformanceComplexityForScenario(PerformanceScenarioHelper.createScenarioOfWorkload(), initialArchitecture),"p1",responseTimePScenario1);//Workload
			PerformanceSillyBot p2Bot=new PerformanceSillyBot(/*74.0173f*/calculatePerformanceComplexityForScenario(PerformanceScenarioHelper.createScenarioOfCPU(), initialArchitecture),"p2",responseTimePScenario2);//CPU
