...
public class PCMDefault {
	...
	public static ResourceRepository loadResourceRepository() {
		if(repositoryResource == null) {
			Resource resource = resourceSet.getResource(URI.createURI("pathmap://PCM_MODELS/Palladio.resourcetype"), true);
	...
	public static EList<DataType> loadPrimitiveTypes() {
		if(repositoryPrimitiveTypes == null) {
			Resource resource = resourceSet.getResource(URI.createURI("pathmap://PCM_MODELS/PrimitiveTypes.repository"), true);
	...
	public static EList<FailureType> loadFailureTypes() {
		if(repositoryPrimitiveTypes == null) {
			Resource resource = resourceSet.getResource(URI.createURI("pathmap://PCM_MODELS/FailureTypes.repository"), true);
