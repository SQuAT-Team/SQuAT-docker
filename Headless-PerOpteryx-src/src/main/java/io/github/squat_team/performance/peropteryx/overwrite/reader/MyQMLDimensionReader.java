 ...
 *
 */
public class MyQMLDimensionReader {
	...
	public Dimension getDimension(String dimensionPath) {
		...
		resourceSet.setURIConverter(PalladioEclipseEnvironment.INSTANCE.getUriConverter());
		...
		for (EObject eObject : resource.getContents()) {
			...
			if (diagnostic.getSeverity() != Diagnostic.OK) {
				new MyQMLDeclarationsReader().printDiagnostic(diagnostic, "");
