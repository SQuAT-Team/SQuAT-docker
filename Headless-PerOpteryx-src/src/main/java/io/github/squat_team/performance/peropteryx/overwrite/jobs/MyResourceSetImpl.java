...
public class MyResourceSetImpl extends ResourceSetImpl {
	 ...
	 /**
	    ...
	    if (resourceFactoryRegistry == null)
	    {
	      resourceFactoryRegistry =
	        new ResourceFactoryRegistryImpl()
	        {
	          ...
	          {
	            return MyResourceSetImpl.this.getURIConverter();
	          }
	  ...
	  protected class ResourcesEList<E extends Object & Resource> extends NotifyingInternalEListImpl<E> implements InternalEList<E>
	  {
	    ...
	    {
	      return MyResourceSetImpl.this.eNotificationRequired();
	    }
	    ...
	    protected NotificationChain inverseAdd(E object, NotificationChain notifications)
	    {
	      ...
	      return resource.basicSetResourceSet(MyResourceSetImpl.this, notifications);
	    }
	    ...
	    {
	      return size <= 4 ? super.contains(object) : object instanceof Resource && ((Resource)object).getResourceSet() == MyResourceSetImpl.this;
	    }
	  }
	  ...
	  public static abstract class ResourceLocator
	  {
	     ...
	     */
	    protected final MyResourceSetImpl resourceSet;
	     ...
	     */
	    public ResourceLocator(MyResourceSetImpl resourceSet)
	    {
	  ...
	  public static class MappedResourceLocator extends ResourceLocator
	  {
	     ...
	     */
	    public MappedResourceLocator(MyResourceSetImpl resourceSet)
	    {
	      super(resourceSet);
