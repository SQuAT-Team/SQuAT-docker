 ...
 *
 */
public class MyPCMDeclarationsReader {
	...
	protected MyQMLDeclarationsReader qmlReader = new MyQMLDeclarationsReader();;
...
//	protected String pcmContractTypeId = null;
	...
	public MyPCMDeclarationsReader(String PCMProfilePath) {
