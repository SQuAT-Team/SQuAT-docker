...
public abstract class MyLQNResult extends AbstractPerformanceAnalysisResult implements ILQNResult{
	...
	private MyLQNQualityAttributeDeclaration qualityAttributeInfo;

	

	public MyLQNResult(PCMInstance pcm, LqnModelType model,
