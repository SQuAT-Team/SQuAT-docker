...
public class MyLQNSolverAnalysis extends MyAbstractLQNAnalysis {
...
//			 throw e;
	...
	protected ILQNResult retrieveResult(PCMInstance pcm,
		...
		ILQNResult result;
		if (hasConverged){
			result = new MyLQNSolverAnalysisResult(model, pcm, criterion, this.criterionToAspect, (MyLQNQualityAttributeDeclaration)this.qualityAttribute);
		} else {
