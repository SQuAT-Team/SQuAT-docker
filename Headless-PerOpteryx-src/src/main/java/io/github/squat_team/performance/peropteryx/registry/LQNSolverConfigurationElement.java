...
import io.github.squat_team.performance.peropteryx.overwrite.analysis.MyLQNSolverAnalysis;
import io.github.squat_team.performance.peropteryx.start.HeadlessPerOpteryxConstants;

public class LQNSolverConfigurationElement implements IConfigurationElement {

	@Override
	public Object createExecutableExtension(String propertyName) throws CoreException {
		return new MyLQNSolverAnalysis();
	}
